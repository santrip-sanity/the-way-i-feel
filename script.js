class MoodTracker {
    ...
    displayWeeklySummary(weeklyMoods, startDate, weekDates) {
        ...
        if (Object.keys(weeklyMoods).length === 0) {
            ...
            html += `<p>Most common mood: ${dominantMood} ${this.moodNames[dominantMood]}</p>`;
        }
