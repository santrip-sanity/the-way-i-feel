class MoodTracker {
    ...
    getTodayKey() {
        ...
        // Use today's month and day, but in the displayed year
        const todayInDisplayYear = new Date(this.currentYear, today.getMonth(), today.getDate());
        return this.formatDate(todayInDisplayYear);
    }
    ...
    updateTrackingStatus() {
        ...
        // Use the app's current display year (not actual current year)
